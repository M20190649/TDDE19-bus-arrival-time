...
Here some text will refer to the figures above, that is figure~\ref{fig:mixture-start-of-traj}, and figure~\ref{fig:mixture-end-of-traj}, and talk about how the final predictions are made. I'm also planning to make a small list of the steps when making predictions to make it really easy to follow below.
